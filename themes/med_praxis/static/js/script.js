  ...
  const translations = {
    de: {
      consent_modal: {
        ...
        description: `Wir verwenden Cookies, um Ihnen die beste Erfahrung auf unserer Website zu bieten. Durch die Nutzung unserer Website stimmen Sie der Verwendung von Cookies zu. Weitere Informationen finden Sie in unserer <a href="${siteUrl}/de/privacy/">Datenschutzerklärung</a>.`,
        primary_btn: {
    ...
    en: {
      consent_modal: {
        ...
        description: `We use cookies to provide you with the best experience on our website. By using our website, you agree to the use of cookies. For more information, please see our <a href="${siteUrl}/en/privacy/">Privacy Policy</a>.`,
        primary_btn: {
          text: 'Accept all',
          role: 'accept_all'
        },
    ...
    ru: {
      consent_modal: {
        ...
        description: `Мы используем cookies, чтобы предоставить вам лучший опыт на нашем сайте. Используя наш сайт, вы соглашаетесь на использование cookies. Для получения дополнительной информации см. нашу <a href="${siteUrl}/ru/privacy/">Политику конфиденциальности</a>.`,
        primary_btn: {
          text: 'Принять все',
          role: 'accept_all'
        },
    ...
    uk: {
      consent_modal: {
        ...
        description: `Ми використовуємо cookies, щоб забезпечити вам найкращий досвід на нашому веб-сайті. Використовуючи наш веб-сайт, ви погоджуєтеся на використання cookies. Для отримання додаткової інформації див. нашу <a href="${siteUrl}/uk/privacy/">Політику конфіденційності</a>.`,
        primary_btn: {
          text: 'Прийняти все',
          role: 'accept_all'
        },
